...
import com.artisan.un.databinding.ItemDeliveredBinding
...
class OrderDeliveredRecyclerViewAdapter : BaseRecyclerViewAdapter() {
    ...
    override fun createViewHolder(inflater: LayoutInflater, parent: ViewGroup, viewType: Int): BaseViewHolder = run {
        ProductListItemHolder(ItemDeliveredBinding.inflate(inflater, parent, false))
    }

    override fun getItemCount() = dataList.size

    inner class ProductListItemHolder(val viewDataBinding : ItemDeliveredBinding) : BaseViewHolder(viewDataBinding) {
