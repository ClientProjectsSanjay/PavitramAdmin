...
public class OtpView extends AppCompatEditText {
    ...
    private final int otpViewItemCount;
    private final int otpViewItemWidth;
    private final int otpViewItemHeight;
    private final int otpViewItemRadius;
    private final int otpViewItemSpacing;
    private final ColorStateList lineColor;
    private int cursorLineColor = getResources().getColor(R.color.warmGray);
    private final int lineWidth;
    private ValueAnimator defaultAddAnimator;
    private final boolean isAnimationEnable = false;
    private Blink blink;
    ...
    private final boolean hideLineWhenFilled;
